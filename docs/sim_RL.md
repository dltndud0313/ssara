...
self.commands.base_velocity.ranges.lin_vel_x = (-0.4, 0.4) -> (0.2, 0,2)

self.commands.base_velocity.ranges.lin_vel_y = (-0.2, 0.2) -> (-0.05, 0.05)

self.commands.base_velocity.ranges.ang_vel_z = (-0.6, 0.6) -> (-0.1, 0.1)